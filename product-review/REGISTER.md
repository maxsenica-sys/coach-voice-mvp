...
| DESIGN-013 | 2026-09-24 | PROPOSED | Stadium Night drawn end to end — eighteen screens from one written spec, the chartreuse discipline holding across all of them, and nine decisions surfaced that are product calls rather than drawing problems | DECIDE | not scored |
